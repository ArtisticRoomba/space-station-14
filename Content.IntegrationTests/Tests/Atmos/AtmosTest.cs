...
{
    [SidedDependency(Side.Server)] protected AtmosphereSystem SAtmos = default!;
    [SidedDependency(Side.Client)] protected Content.Client.Atmos.EntitySystems.AtmosphereSystem CAtmos = default!;
